...
public class UserRepository {
    ...
    //회원 등록
    public UserAddressDto save(UserAddressDto userAddressDto) throws SQLException {
        ...
        try {
            ...
            pstmt.setString(1, userAddressDto.getName()); //parameterIndex
            pstmt.setString(2, userAddressDto.getEmail());
            pstmt.setInt(3, userAddressDto.getGender());
            pstmt.executeUpdate();
